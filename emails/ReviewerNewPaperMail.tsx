...
interface ReviewerNewPaperEmailProps {
  reviewerName: string;
  paperTitle: string;
...
export default function ReviewerNewPaperEmail({
  reviewerName,
  paperTitle,
  paperAbstract,
  authorName,
  submissionDate,
  reviewUrl = 'http://localhost:3000/dashboard'
}: ReviewerNewPaperEmailProps) {
  return (
    <Html lang="en" dir="ltr">
      ...
      <Preview>New paper assigned for your review</Preview>
      ...
      <Container style={containerStyle}>
        <Section style={cardStyle}>
          ...
          <Text style={textStyle}>
            You have been assigned a new paper to review in the JEDSD system. Please find the details below:
          </Text>
          ...
          <Section style={instructionsBoxStyle}>
            <Text style={instructionsTextStyle}>
              <strong>Next Steps:</strong> Please review the paper and provide your feedback. You can accept or reject the paper for review through the dashboard.
            </Text>
          </Section>
