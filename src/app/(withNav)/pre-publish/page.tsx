  ...
  const fetchPapers = async (resetPage = false) => {
    ...
    try {
      ...
      if (axios.isAxiosError(error)) {
        ...
        toast.error(`Failed to fetch accepted papers: ${error.response?.data?.message || error.message}`);
      } else {
  ...
  const handleFilterChange = (key: keyof SearchFilters, value: string) => {
    setFilters(prev => {
      ...
      setTimeout(() => {
        ...
        if (newFilters.sortBy !== "acceptedDate") params.set("sortBy", newFilters.sortBy);
          ...
          <Card className="sticky top-4">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="title-search" className="flex items-center gap-2">
              ...
              {/* Author Search */}
              <div className="space-y-2">
                <Label htmlFor="author-search" className="flex items-center gap-2">
              ...
              {/* Abstract Search */}
              <div className="space-y-2">
                <Label htmlFor="abstract-search" className="flex items-center gap-2">
                  <FileText className="h-4 w-4" />
                  Abstract
                </Label>
                <Input
              ...
              {availableYears.length > 0 && (
                <div className="space-y-2">
                  ...
                  <Select 
                    ...
                    onValueChange={(value) => handleFilterChange("yearFilter", value === "all" ? "" : value)}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
              ...
              {/* Clear Filters */}
              {(filters.titleQuery || filters.keywordQuery || filters.authorQuery || 
                filters.abstractQuery || filters.yearFilter) && (
                <Button 
                  variant="outline" 
                  onClick={() => {
                    setFilters({
          ...
          {loading ? (
            ...
            <Card>
              <CardContent className="flex flex-col items-center justify-center py-12">
                ...
                <h3 className="text-lg font-semibold mb-2">No Accepted Papers Found</h3>
            ...
            <>
              ...
              <div className="flex justify-between items-center mb-6">
                <p className="text-sm text-muted-foreground">
                  Showing {((page - 1) * 5) + 1}-{Math.min(page * 5, totalResults)} of {totalResults} accepted papers
                </p>
              ...
              <div className="space-y-6">
                {papers.map((paper) => (
                  <Card key={paper.id} className="hover:shadow-lg transition-shadow border-l-4 border-l-green-500">
                    <CardContent className="p-6">
                      ...
                      <div className="flex flex-wrap items-center gap-4 text-sm text-muted-foreground mb-4">
                        ...
                        {paper.acceptedDate && (
                          <div className="flex items-center gap-1">
                            ...
                            <span className="text-green-600">Accepted: {formatDate(paper.acceptedDate)}</span>
                          </div>
                        )}
                      </div>
